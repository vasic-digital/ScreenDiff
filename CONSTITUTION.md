# CONSTITUTION — ScreenDiff

Project-specific governance for the **ScreenDiff** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
